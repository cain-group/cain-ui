...
export const CaHeader = /*@__PURE__*/createReactComponent<JSX.CaHeader, HTMLCaHeaderElement>('ca-header');
export const CaIcon = /*@__PURE__*/createReactComponent<JSX.CaIcon, HTMLCaIconElement>('ca-icon');
export const CaLink = /*@__PURE__*/createReactComponent<JSX.CaLink, HTMLCaLinkElement>('ca-link');
export const CaMain = /*@__PURE__*/createReactComponent<JSX.CaMain, HTMLCaMainElement>('ca-main');
export const CaRow = /*@__PURE__*/createReactComponent<JSX.CaRow, HTMLCaRowElement>('ca-row');
